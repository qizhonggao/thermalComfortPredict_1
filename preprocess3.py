...
df2 = pd.read_csv('ashrae_db2.csv', usecols=['Season', 'PMV', 'Air temperature', 'Relative humidity', 'Outdoor air temperature'])
...
df2_cleaned.to_csv('cleaned_asds32.csv', index=False)
